...
router.get('/clientes', async (req, res) => {
    try {
        ...
        res.redirect('/dashboard'); // A un lugar seguro
    }
});
...
router.get('/clientes/detalles/:id', async (req, res) => {
    try {
        ...
        res.render('admin/cliente-detalles', { // Suponiendo que existe esta vista
...
router.get('/perfil', perfilController.getAdminProfile); // Esta función debe renderizar 'admin/perfil'
