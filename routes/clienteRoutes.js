...
router.get('/clientes/:rut', requireAuth, clienteController.obtenerCliente);
router.post('/clientes', requireAdmin, clienteController.crearCliente);
router.put('/clientes/:rut', requireAdmin, clienteController.actualizarCliente);
router.delete('/clientes/:rut', requireAdmin, clienteController.eliminarCliente);
